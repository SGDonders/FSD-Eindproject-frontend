    ...
    return (
        <>
            ...
            <main>
                ...
                <form onSubmit={handleSubmitPost} className="outer-container" id="outer-container__post">
                    <section className="inner-container" id="inner-container__post">
                        <div className="post-form__innercontainer">
                ...
                <form onSubmit={handleSubmitDelete} className="outer-container" id="outer-container__delete">
                    <section className="inner-container" id="inner-container__delete">
                        <div className="delete-form__innercontainer">
                ...
                <form onSubmit={handleSubmitPatch} className="outer-container" id="outer-container__patch">
                    <section className="inner-container" id="inner-container__patch">
                        <div className="patch-form__innercontainer">
                ...
                <section className="outer-container" id="outer-container__img">
                    <div className="inner-container" id="inner-container__img">
                        ...
                        <form className="img-form" onSubmit={uploadProfilePicture}>
                            <label>
                                <input onChange={HandleFileChange} type="file" name="file" accept="image.*"/>
                            </label>
                            {previewURL &&
